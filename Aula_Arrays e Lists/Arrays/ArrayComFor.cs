...
public class ArrayImparPar
{
    ...
    public void converterArray()
    {
        ...
        {
            MensagemConsole.errorMsg("O array está vazio");
            return;
        }
        ...
        MensagemConsole.successMsg($"Array ({arrayAntigo}) Convertido para {tipo_atual_do_array}: {string.Join(',', this.arrayInt)}");
    }
    ...
    public void gerarNumerosImpares()
    {
        ...
        MensagemConsole.successMsg($"Array atualizado com numeros Impares: {string.Join(',', this.arrayInt)}");
    ...
    public void gerarNumerosPares()
    {
        ...
        Array.Sort(pares);
        this.arrayInt = pares;
        MensagemConsole.successMsg($"Array atualizado com numeros Pares: {string.Join(',', this.arrayInt)}");
